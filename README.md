...
4. There's this great rat map tutorial ([tutorial here](http://maptimeboston.github.io/leaflet-intro/) and [repo here](https://github.com/maptimeBoston/leaflet-intro))that's quite easy to follow but covers a lot (basic geographic features, styling, basic interactivity), which I really like. However, I couldn't get it to load when [I hosted it on Github](https://github.com/Shadrock/first-leaflet-map). 
